      ...
      <div class="container">
        ...
        <div class="row mt-4">
          <div class="col-lg align-items-strech">
            ...
            <div class="row">
              <div class="col-lg align-items-strech">
                <a href="{{ url('/' . $governanceObjectCompany->companyId . '/' . $governanceObjectCompany->domainCompanyId . '/' . $governanceObjectCompany->governanceObjectId . '/' . $governancePractice->governancePracticeId )}}">
                  <div class="card w-100">
                    <div class="card-body">
                      <div class="row d-flex align-items-center">
                        <div class="col-10">
                          <div class="row">
                            <div class="d-sm-flex d-block align-items-center justify-content-between">
                              <div class="mb-3 mb-sm-0">
                                <h3>{{ $governancePractice->governancePracticeId}} | {{ $governancePractice->governancePractice->governancePracticeName}} </h3>
                              </div>
                              <h3>{{ $governancePractice->governancePracticeCompanyLevel ?? 'Level'}}</h3>
                            </div>
                          </div>
                        </div>
                        <div class="col-2 d-flex align-items-center justify-content-center">
                          <div class="circle">{{ $governancePractice->governancePracticeCompanyScore ?? '0'}}%</div>
                        </div>
                      </div>
                    </div>
                  </div>
