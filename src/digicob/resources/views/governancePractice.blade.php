                                                            ...
                                                            <div class="col-10">
                                                                <div class="row">
                                                                    @php
                                                                        $hidden = '';
                                                                        $classification = null;
                                                                        $score = ($activitiesCompany->activitiesCompanyScore) ? $activitiesCompany->activitiesCompanyScore : 0;
                                                                        ...
                                                                        if (
                                                                            ...
                                                                            empty($activitiesCompany->activitiesCompanyRecommendations) &&
                                                                            ...
                                                                            empty($activitiesCompany->activitiesCompanyPersonInCharge)
                                                                        ) {
                                                                            $hidden = 'display: none;';
                                                                        }
                                                                    @endphp
