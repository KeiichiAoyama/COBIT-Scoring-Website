            ...
            <nav class="sidebar-nav scroll-sidebar">
                <ul id="sidebarnav">
                    <li class="sidebar-item">
                        <a class="btn btn-primary" href="{{ route('newCompany')}}"><i class="ti ti-plus"></i> New
                            Company</a>
                    </li>
                    ...
                    @foreach ($userCompanyList as $userCompany)
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ url('/' . $userCompany->companyId)}}" aria-expanded="false">
                                    ...
                                    <div class="card-body">
                                        <div class="row d-flex align-items-center">
                                            <div class="col-10">
                                                ...
                                                <div class="row">
                                                    @php
                                                        $filteredDomainCompanyList = $domainCompanyList->filter(function ($domainCompany) use ($company) {
                                                            return $domainCompany->companyId == $company->companyId;
                                                        });
                                                    @endphp
                                                    @foreach ($filteredDomainCompanyList as $domain)
                                                        <div class="col-3 p-1">
                                                            <a href="{{ url('/' . $domain->companyId . '/' . $domain->domainId)}}"
                                                                class="btn btn-danger btn-round w-100 h-5">
