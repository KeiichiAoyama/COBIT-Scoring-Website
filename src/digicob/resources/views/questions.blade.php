                ...
                <div class="card-body p-5">
                  <div
                    ...
                    <div class="row">
                      ...
                      <div class="col">
                        <h4>{{$governancePracticeCompany->governancePractice->governancePracticeId}}</h4>
                        ...
                        <form action="{{ url('/save-audit-next')}}" method="POST" >
                          ...
                          <div class="row">
                            <div class="col-4">
                              ...
                              type="text"
                              class="form-control"
                              id="activitiesCompanyScore"
                              name="activitiesCompanyScore"
                              value=""
                              required />
                            </div>
                            <h5 class="col">%</h5>
                          ...
                          @if (session('message'))
                          <label class="form-label" for="activitiesCompanyFindings"
                          >Findings</label
                          >
                          <input
                          class="form-control"
                          type="text"
                          name="activitiesCompanyFindings"
                          id="activitiesCompanyFindings" />
                          <label class="form-label" for="activitiesCompanyImpact">Impact</label>
                          <input
                          class="form-control"
                          type="text"
                          name="activitiesCompanyImpact"
                          ...
                          class="form-control"
                          type="text"
                          name="activitiesCompanyResponse"
                          id="activitiesCompanyResponse" />
                          <div class="row g-3 mt-1">
                            <div class="col-4">
                              <label class="form-label" for="activitiesCompanyStatus"
                              >Status</label
                              >
                              <input
                              class="form-control"
                            ...
                            <div class="col-4">
                              <label class="form-label" for="activitiesCompanyDeadline"
                              >Deadline</label
                              >
                              <input
                              class="form-control"
